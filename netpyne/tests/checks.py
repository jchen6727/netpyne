        ...
        for feature, expected in expectedAll.items():
            ...
            if feature == "numCells":
                for pop in expected:
                    try:
                        ...
                        print(
                            (
                                "\nMismatch: model %s population %s %s is %s but expected value is %s"
                                % (modelName, pop, feature, actual, expected[modelName][pop])
                            )
                        )
                        raise
            ...
            if feature == "numSyns":
                try:
                    ...
                    print(
                        (
                            "\nMismatch: model %s %s is %s but expected value is %s"
                            % (modelName, feature, actual, expected[modelName])
                        )
                    )
                    raise
